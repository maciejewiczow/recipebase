...
export const GDriveFilePickerView: React.FC<NativeStackScreenProps<RootStackParams, 'GDriveFilePicker'>> = ({
    navigation,
    route,
}) => {
    ...
    //                 q: new ListQueryBuilder().in(route.params.currentFolderId || 'root', 'parent'),
    //             })) as FilesResponse,
    //         );
    //     })();
